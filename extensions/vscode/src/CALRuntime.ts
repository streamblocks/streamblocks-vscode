...
/**
 * A CAL runtime with minimal debugger functionality.
 */
export class CALRuntime extends EventEmitter {
	...
	/**
	 * "Step into" for CAL "debug" means = go to next character
	 */
	...
	/**
	 * "Step out" for CAL "debug" means = go to previous character
	 */
	public stepOut() {
		if (typeof this._currentColumn === 'number') {
			this._currentColumn -= 1;
	...
	/**
	 * "execute a line" of the CAL file.
